...
#define RECOVERY_PROTOCOL_VERSION UINT8_C(2)
#define RECOVERY_PACKET_SIZE 64U
#define RECOVERY_PAYLOAD_SIZE 32U

#define RECOVERY_FLAG_SLOT_MASK UINT16_C(0x0001)
#define RECOVERY_FLAG_FULL_FLASH UINT16_C(0x8000)
#define RECOVERY_FLAG_ALLOWED_MASK \
    (RECOVERY_FLAG_SLOT_MASK | RECOVERY_FLAG_FULL_FLASH)

#define RECOVERY_FULL_FLASH_UNLOCK UINT32_C(0x45504957)
...
enum recovery_command {
    ...
    RECOVERY_COMMAND_BEGIN_FULL_FLASH = 10,
    RECOVERY_COMMAND_ERASE_FULL_FLASH = 11,
    RECOVERY_COMMAND_FINALIZE_FULL_FLASH = 12,
    RECOVERY_COMMAND_READ_KNOBS = 13,
};
...
enum recovery_status {
    ...
    RECOVERY_STATUS_FULL_FLASH_DISABLED = 18,
};
